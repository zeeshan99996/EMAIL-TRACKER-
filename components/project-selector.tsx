  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-full flex items-center justify-between px-3.5 py-2.5 text-sm font-bold text-white bg-black/25 hover:bg-black/40 border border-white/25 hover:border-white/40 rounded-xl transition-colors shadow-xs backdrop-blur-md"
      >
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-1.5 bg-[#092956]/98 border border-white/30 rounded-xl shadow-2xl z-50 py-1.5 backdrop-blur-xl">
          ...
          <button
            ...
            className="w-full text-left px-3.5 py-2 text-sm text-white hover:bg-white/15 flex items-center space-x-2 font-medium"
          >
            <span className="w-2 h-2 rounded-full bg-slate-300"></span>
            <span className="truncate text-white">ERHA Marketing</span>
          </button>
          <div className="border-t border-white/20 my-1"></div>
          <a
            href="/dashboard/projects"
            className="w-full text-left px-3.5 py-2 text-xs font-bold text-white hover:bg-white/15 flex items-center space-x-1.5"
          >
            <Plus className="w-3.5 h-3.5 text-white" />
            <span className="text-white font-bold">Manage Projects</span>
          </a>
        </div>
      )}
    </div>

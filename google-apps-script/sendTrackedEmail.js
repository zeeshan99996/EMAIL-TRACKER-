 ...
 * 4. Replace API_KEY with your API key from your dashboard.
 ...
 * Includes plain text fallback to ensure high deliverability and avoid spam filters.
 */
function sendTrackedEmailViaGmail() {
  const recipientEmail = "client@example.com"; // Replace with recipient email (send to another address to test inbox delivery)
  ...
  // Convert HTML to clean plain text (crucial for passing Gmail & Outlook spam checks)
  const plainTextBody = `Hello,

Thank you for reaching out. Here is our proposal for your web development project.

View Our Services & Scope: https://erhatechnologies.com/services
Portfolio & Case Studies: https://erhatechnologies.com/portfolio
...
function sendBulkTrackedEmailsFromSheet() {
  ...
  for (let i = 1; i < data.length; i++) {
    ...
    const plainText = `Hi ${name},\n\nHere is our latest update. Click here to view services: https://erhatechnologies.com/services`;
